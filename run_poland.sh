...
python weekend_score.py -i poland_animation.pickle -s 2022-02-14 -e 2022-03-28 -o PolandWeekEndPlots --figname poland_week_end_score.png --export_data poland_weekend.csv
...
python plot_precomputed_map.py -i poland_slip.csv --country Poland --outdir PolandSlipMap --colorscale 0 1 --cities cities.txt --roads europe-road.geojson --borders border_crossings.tsv --colormap Blues 
